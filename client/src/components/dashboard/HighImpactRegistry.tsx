...
export function HighImpactRegistry({
  ...
  const [contactPatient, setContactPatient] = useState<{ id: string; name: string } | null>(null)
                        ...
                        <div className="relative inline-block">
                          ...
                          {openMenuId === patient.id && (
                            <PatientActionMenu
                              ...
                              onAddNote={() => setNotePatient({ id: patient.id, name: fullName })}
                              onMarkContacted={() => setContactPatient({ id: patient.id, name: fullName })}
                            />
                          )}
                        </div>
                      </td>
