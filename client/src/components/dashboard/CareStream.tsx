...
import type { CareStreamEvent, CareStreamEventType } from '@healthstream/shared'
...
export function CareStream({ events, loading = false }: CareStreamProps) {
  return (
    <div className="rounded-xl bg-white border border-gray-100 shadow-sm p-6 flex flex-col">
      ...
      <button
        className="mt-4 self-end h-12 w-12 rounded-full bg-brand-500 text-white flex items-center justify-center shadow-lg hover:bg-brand-600 transition-colors"
