...
import type { PatientFlow } from '@healthstream/shared'
...
const stageStyles: Record<StageProps['variant'], string> = {
  identified: 'bg-brand-50 border-l-4 border-brand-500 text-brand-600',
  ...
  return (
    <div className="rounded-xl bg-white border border-gray-100 shadow-sm p-6">
      <div className="flex items-start justify-between mb-5">
        ...
        <button className="text-sm text-brand-500 font-medium hover:underline whitespace-nowrap flex items-center gap-1">
